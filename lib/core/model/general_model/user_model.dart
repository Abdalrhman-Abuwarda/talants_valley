...
import 'package:talants_valley/core/model/general_model/user-data_model.dart';
...
class UserModel {
  ...
  factory UserModel.fakeData() => UserModel._(
      ...
      verifiedAddress: VerifiedAddress.fakeVerifiedAddress(),
      verifiedId: VerifiedId.fakeVerifiedId(),
      role: 0,
      address: null,
      isBlocked: false,
      createdAt: "",
